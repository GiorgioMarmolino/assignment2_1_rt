...
def planning(goal):
    ...
    result = assignment2_1_rt.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', assignment2_1_rt.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
